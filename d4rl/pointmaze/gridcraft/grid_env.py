...
from d4rl.pointmaze.gridcraft.grid_spec import REWARD, REWARD2, REWARD3, REWARD4, TOXIC, WALL, LAVA, TILES, START, RENDER_DICT, CHASER, TOXIC, TOXIC2, BOX, CORNER
...
ACT_LEFT = 3
ACT_RIGHT = 4
ACT_DICT = {ACT_NOOP: [0, 0], ACT_UP: [0, -1], ACT_LEFT: [-1, 0], ACT_RIGHT: [+1, 0], ACT_DOWN: [0, +1]}
ACT_TO_STR = {ACT_NOOP: 'NOOP', ACT_UP: 'UP', ACT_LEFT: 'LEFT', ACT_RIGHT: 'RIGHT', ACT_DOWN: 'DOWN'}
